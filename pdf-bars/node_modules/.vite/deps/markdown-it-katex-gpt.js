...
// node_modules/markdown-it-katex-gpt/index.js
var defaultOptions = {
  delimiters: [
...
function markdown_it_katex_gpt_default(md, options = defaultOptions) {
  md.inline.ruler.after("text", "escaped_bracket", escapedBracketRule(options));
}
export {
  markdown_it_katex_gpt_default as default
};
//# sourceMappingURL=markdown-it-katex-gpt.js.map
